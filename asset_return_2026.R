...
daily <- "2026-03-18	-0.032	-0.047	-0.024	-0.127	-0.091	-0.190	-0.067	-0.081	-0.033	-0.107	-0.069	-0.084	0.122	0.684	-0.194
2026-03-19	-0.035	-0.050	-0.026	-0.154	-0.096	-0.196	-0.081	-0.084	-0.043	-0.106	-0.059	-0.079	0.076	0.681	-0.203"
daily <- gsub("\\s+", ",", daily)
daily
...
updates <- tribble(~date, ~`S&P500`, ~"NASDAQ", ~"Google",  ~"Tesla", ~"Amazon", ~"Microsoft",  ~"Meta",  ~"Apple", ~"NVIDIA", ~`JP Morgan`, ~"Citigroup", ~`Goldman Sachs`,  ~"Gold", ~"WTI", ~"Bitcoin",
                   "2026-03-18",-0.032,-0.047,-0.024,-0.127,-0.091,-0.190,-0.067,-0.081,-0.033,-0.107,-0.069,-0.084,0.122,0.684,-0.194,
                   "2026-03-19",-0.035,-0.050,-0.026,-0.154,-0.096,-0.196,-0.081,-0.084,-0.043,-0.106,-0.059,-0.079,0.076,0.681,-0.203)
